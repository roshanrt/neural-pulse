  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 items-start">
        <div className="space-y-4 glass-panel p-6 md:p-8">
          <h2 className="font-display font-bold text-xl text-slate-900">What you’ll get</h2>
          <div className="space-y-4">
            {highlights.map((item) => {
              const Icon = item.icon;
              return (
                <div key={item.title} className="flex gap-4 rounded-xl bg-slate-100/70 p-4">
        ...
        <div className="glass-panel p-6 md:p-8">
          <h2 className="font-display font-bold text-xl text-slate-900 mb-3">Subscribe now</h2>
