    ...
    >
      <div className="grid gap-6">
        ...
        <div className="glass-panel p-6 md:p-8 space-y-3">
          <h2 className="font-display font-bold text-xl text-slate-900">What to include</h2>
          <p className="text-slate-600 leading-relaxed">Share the relevant links, context, and deadlines so the editorial team can verify and act quickly.</p>
